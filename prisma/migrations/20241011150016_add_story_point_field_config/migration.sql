...
INSERT INTO "new_Team" ("createdAt", "id", "lastSlackDate", "name", "slackDaysOfWeek", "slackHour", "slackMessageConfig", "teamLeadId", "updatedAt") SELECT "createdAt", "id", "lastSlackDate", "name", "slackDaysOfWeek", "slackHour", "slackMessageConfig", "teamLeadId", "updatedAt" FROM "Team";
DROP TABLE "Team";
